...
public interface TrabajadorRepository extends CrudRepository<Trabajador, String>
{
    ...
    @Query("SELECT t FROM Trabajo t, Trabajador u WHERE t.idTrabajador.idTrabajador = u.idTrabajador AND t.idTrabajador = :id_trabajador AND u.contrasenya = :password AND t.fecFin IS NOT NULL")
